function LnagPack(thisLang){
    ...
    l.en.gn.hcModelTitle='Interactive Simulation Model of Hamming Code - Matrix Algorithm';
    l.bg.gn.hcModelTitle='Интерактивен Симулационен Модел на Код на Хеминг - Матричен Алгоритъм';
