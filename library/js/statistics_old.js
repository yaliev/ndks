...
createStatistics = function(lang){
	...
	// jquery dialog
	stat.errDialog = $("#errDialog").dialog({autoOpen : false, modal : false, show : "blind", hide : "blind",
											 width: 'auto', height:'auto', minWidth:250, maxHeight:500});
	...
	stat.error.insert = function(errors){
		stat.error.count = errors.count;
		stat.error.history = errors.history;
		stat.error.val.text(stat.error.count);
		errors.history.forEach(err =>{
